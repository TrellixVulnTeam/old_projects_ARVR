...
public class SalesSystemUI extends Application {
    ...
    public static void showErrorDialog(ErrorType errorType, String content) {
        Alert alert = new Alert(Alert.AlertType.ERROR);
        alert.setTitle("Error");
        alert.setHeaderText(errorType.getHeader());
    ...
    public enum ErrorType {
        INPUT("Input Error!"),
        STARTUP("A problem occurred during startup!");

        private final String header;

        ErrorType(String header) {
            this.header = header;
        }
